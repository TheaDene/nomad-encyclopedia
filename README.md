...
```sh
git clone https://github.com/TheaDene/nomad-encyclopedia.git
cd nomad-encyclopedia
...
| Name | E-mail     |
|------|------------|
| Thea Denell | [thea.denell@physik.hu-berlin.de](mailto:thea.denell@physik.hu-berlin.de)
